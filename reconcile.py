...
api_base_url = (
    "http://api.geonames.org/searchJSON?username="
    + geonames_username
    + "&isNameRequired=yes&"
)
...
default_query = {"id": "/geonames/all", "name": "All GeoNames terms", "index": "q"}

refine_to_geonames = [
    {"id": "/geonames/name", "name": "Place Name", "index": "name"},
    {
        "id": "/geonames/name_startsWith",
        "name": "Place Name Starts With",
        "index": "name_startsWith",
    },
    {"id": "/geonames/name_equals", "name": "Exact Place Name", "index": "name_equals"},
]
